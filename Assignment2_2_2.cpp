...
class tollbooth{
    ...
    void payingcar(){
        ...
        cout<<"Entry Successfull for Paying Car"<<endl;
    ...
    void nonpayingcar(){
        //nopay=nopay+1;
        n=n+1;
        cout<<"Entry Successfull for Non Paying Car"<<endl;
    ...
    void total()
    {
        ...
        unsigned int p;
        p=((n*.50)-money )/(.50);
        cout<<"Paying Cars:"<<n-p<<endl;
        cout<<"Non Paying Cars:"<<p<<endl;
        cout<<"Total Money(In Cents):"<<money<<endl;
        
    }
    void display()
    {
        unsigned int p = ((n*50)-money )/50;
        cout<<"-----------------------------------------"<<endl;
        cout<<"Paying Cars:"<<n-p<<endl;
        cout<<"Non Paying Cars:"<<p<<endl;
        cout<<"No of Cars:"<<n<<endl;
